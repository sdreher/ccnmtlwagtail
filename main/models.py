...
from ccnmtlwagtail.main.utils import export_event
...
class AdvertPlacement(models.Model):
    ...
    advert = models.ForeignKey('main.Advert', related_name='+')
...
class HomePageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('main.HomePage', related_name='carousel_items')


class HomePageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('main.HomePage', related_name='related_links')
...
class StandardIndexPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('main.StandardIndexPage', related_name='related_links')
...
class StandardPageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('main.StandardPage', related_name='carousel_items')


class StandardPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('main.StandardPage', related_name='related_links')
...
class BlogPageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('main.BlogPage', related_name='carousel_items')


class BlogPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('main.BlogPage', related_name='related_links')


class BlogPageTag(TaggedItemBase):
    content_object = ParentalKey('main.BlogPage', related_name='tagged_items')
...
class PersonPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('main.PersonPage', related_name='related_links')
...
class EventIndexPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('main.EventIndexPage', related_name='related_links')
...
class EventPageCarouselItem(Orderable, CarouselItem):
    page = ParentalKey('main.EventPage', related_name='carousel_items')


class EventPageRelatedLink(Orderable, RelatedLink):
    page = ParentalKey('main.EventPage', related_name='related_links')


class EventPageSpeaker(Orderable, LinkFields):
    page = ParentalKey('main.EventPage', related_name='speakers')
