...
from ccnmtlwagtail.main.models import PersonPage, BlogPage, EventPage, Advert
...
@register.inclusion_tag('main/tags/top_menu.html', takes_context=True)
...
@register.inclusion_tag('main/tags/top_menu_children.html', takes_context=True)
...
@register.inclusion_tag(
    'main/tags/standard_index_listing.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'main/tags/person_listing_homepage.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'main/tags/blog_listing_homepage.html',
    takes_context=True
)
...
@register.inclusion_tag(
    'main/tags/event_listing_homepage.html',
    takes_context=True
)
...
# Advert snippets
@register.inclusion_tag('main/tags/adverts.html', takes_context=True)
def adverts(context):
    return {
...
@register.inclusion_tag('main/tags/breadcrumbs.html', takes_context=True)
